    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{ route('index') }}">E BookHub <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="{{ route('index') }}">Home <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('books.index') }}" style="display: none;">Recent Books</a>
          </li>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link" href="{{ route('books.upload') }}">Upload Books</a>
