  ...
  <div id="carouselExampleIndicators" class="carousel slide main-slider" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="{{ asset('images/sliders/s01.jpg') }}" class="d-block w-100">
        <div class="carousel-caption d-none d-md-block">
          <h3>Welcome to E BookHub</h3>
          <p>
            <a href="register.html" class="btn btn-primary slider-link" style="display: none;">
              Get Start Now
            </a>
          </p>
        </div>
      ...
      <div class="carousel-item">
        <img src="{{ asset('images/sliders/s02.jpg') }}" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h3>Welcome to E BookHub</h3>
          <p>
            <a href="" class="btn btn-primary slider-link" style="display: none;">
              New Account
            </a>
          </p>
        </div>
      ...
      <div class="carousel-item">
        <img src="{{ asset('images/sliders/s03.jpg') }}" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h3>Welcome to E BookHub</h3>
          <p>
            <a href="" class="btn btn-primary slider-link" style="display: none;">
